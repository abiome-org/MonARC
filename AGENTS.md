...
|   |   +-- eval_place_score.py # CPU stored-grid, reencoded-crop, and same/mixed-gallery overlap verification
...
|   +-- test_eval_place_score.py # Fixture-only same-place AUROC, Recall@1, inliers, and CLI contract
